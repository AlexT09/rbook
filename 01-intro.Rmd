...
Se convierten `Order Date` y `Ship Date` de texto a fecha usando `mdy()` de lubridate
(formato mes/día/año, como vienen en el archivo), y con `arrange()` se ordenan las
filas por fecha de pedido.

# --- Carga ---
write_csv(df, "superstore_transformado.csv")
Se convierten Order Date y Ship Date de texto a fecha usando mdy() de lubridate (formato mes/día/año, como vienen en el archivo), y con arrange() se ordenan las filas por fecha de pedido.
